...
Q_CONSTINIT static const qt_meta_stringdata_CLASSMenuWidgetENDCLASS_t qt_meta_stringdata_CLASSMenuWidgetENDCLASS = {
    {
        ...
        QT_MOC_LITERAL(11, 17),  // "playButtonClicked"
        QT_MOC_LITERAL(29, 0),  // ""
        QT_MOC_LITERAL(30, 19)   // "onPlayButtonClicked"
    },
    "MenuWidget",
    "playButtonClicked",
    "",
...
void MenuWidget::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            ...
            if (_t _q_method = &MenuWidget::playButtonClicked; *reinterpret_cast<_t *>(_a[1]) == _q_method) {
                *result = 0;
                return;
            }
        }
