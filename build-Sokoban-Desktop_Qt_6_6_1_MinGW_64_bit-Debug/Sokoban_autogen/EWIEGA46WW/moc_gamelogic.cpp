...
Q_CONSTINIT static const qt_meta_stringdata_CLASSGameLogicENDCLASS_t qt_meta_stringdata_CLASSGameLogicENDCLASS = {
    {
        ...
        QT_MOC_LITERAL(10, 13),  // "reportVictory"
        QT_MOC_LITERAL(24, 0),  // ""
        QT_MOC_LITERAL(25, 11)   // "gridUpdated"
    },
    "GameLogic",
    "reportVictory",
    "",
...
void GameLogic::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        (void)_t;
        switch (_id) {
        case 0: _t->reportVictory(); break;
        case 1: _t->gridUpdated(); break;
        default: ;
        }
        ...
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            ...
            if (_t _q_method = &GameLogic::reportVictory; *reinterpret_cast<_t *>(_a[1]) == _q_method) {
                *result = 0;
                return;
            }
        }
        {
            using _t = void (GameLogic::*)();
            if (_t _q_method = &GameLogic::gridUpdated; *reinterpret_cast<_t *>(_a[1]) == _q_method) {
                *result = 1;
                return;
            }
        }
...
// SIGNAL 0
void GameLogic::reportVictory()
{
    QMetaObject::activate(this, &staticMetaObject, 0, nullptr);
}

// SIGNAL 1
void GameLogic::gridUpdated()
{
